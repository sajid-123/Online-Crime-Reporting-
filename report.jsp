...
<body>
	...
	<header class="w3-container w3-red w3-center" style="padding: 18px 0px">
		<img src="download5.jpg" style="mrgin: 0" />
	...
	<div class="w3-container w3-red w3-center" style="padding: 18px 0px">
		...
		<form action="record" style="max-width: 500px; margin: auto"
			method="post">
		...
		<a href="sdate.jsp"
			class="w3-button w3-black w3-padding-large w3-large w3-margin-top">Monthly
			Record Access</a>
	...
	<div class="w3-container w3-red ">
		<img src="download.jpg" style="margin-left: 0px" width="300px"
			height="200px" /> <img src="download3.jpg" style="margin-left: 30px"
			width="300px" height="200px" /> <img src="download7.jpg"
			style="margin-left: 30px" width="300px" height="200px" /> <img
			src="download8.jpg" style="margin-left: 30px" width="300px"
			height="200px" />
	</div>
	<!-- Footer -->
